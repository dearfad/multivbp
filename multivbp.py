...
【查体】
体温39.4度，心率98次/分，呼吸22次/分，血压130/80mmHg。神志清楚，痛苦面容，发育、营养良好，心脏、肺部、腹部查体未见异常。左侧乳房肿痛，发热，以内上方为主，明显压痛，范围约8cm*6cm，边界不清，中心部位皮肤呈暗红色，波动感阳性，左侧腋窝可触及2枚肿大淋巴结，约1.5cm✖1cm大小,有压痛

【辅助检查】
实验室检查：血红蛋白128g/L，白细胞26.9，中性粒细胞0.86，血小板155
超声检查：左侧乳房10点位可见3cm*3cm不均匀偏低回声区，内部呈流动性改变
'''
...
for llm in LLMS:
    if llm not in st.session_state:
        st.session_state[llm] = [{'role': 'system', 'content': system_msg},{'role': 'user', 'content': '你好，我是你的'},{'role': 'assistant', 'content': '大夫，我乳房不舒服'}]
